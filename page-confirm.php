...
<div class="p-contact l-wrapper">
  ...
  <div class="p-contact__wrap">
    <div class="c-sec-heading p-contact__heading">
      <h2 class="c-sec-heading__en">CONFIRM</h2>
      <p class="c-sec-heading__ja">入力内容を確認ください</p>
    </div><!-- /.c-sec-heading -->
    ...
    <div class="p-contact-step">
      <ul class="p-contact-step__list">
        ...
        <li class="p-contact-step__item">
          ...
          <p class="p-contact-step__text">入力内容の確認を<br class="u-sp">お願いします</p>
        </li>
        <li class="p-contact-step__item">
          <div class="p-contact-step__circle disable">完了</div>
          <p class="p-contact-step__text disable">お問い合わせ<br class="u-sp">ありがとうござました</p>
        </li>
      </ul>
    </div><!-- /.p-contact-step -->
