...
<div class="p-news l-wrapper">
  ...
  <div class="l-page-head">
    ...
    <div class="l-page-head__texts">
      <h1 class="l-page-head__title l-page-head__title--info">
        <span class="l-page-head__ja"><?php echo $catName; ?></span>
        <span class="l-page-head__en"><?php echo $catSlug; ?></span>
      </h1>
  ...
  <div class="c-sec-heading p-news__heading">
    <h2 class="c-sec-heading__en"><?php echo $catSlug; ?></h2>
    <p class="c-sec-heading__ja"><?php echo $catName; ?></p>
  </div><!-- /.c-sec-heading -->
